    ...
    [20], {
        ...
        324: function (t, e) {
            t.exports = function (t) {
                t.options.__i18n = t.options.__i18n || [], t.options.__i18n.push('{"ja":{"title":"Solutions","mission":{"1":"螺旋","2":"永不经过同一位置","3":"无限期上升的结构","4":"我们的使命是不断更新我们产生的创意，并创建可以与品牌和社会一起前进的业务。"},"introduction":"我们的优势是拥有通过创造性工作获得的知识，并拥有可以利用其知识进行运作的业务实体。 它提供了解决问题的途径，只有 Helicx 才能做到，同时保持输出的尊严和技能。","creative":"我们将使用最适合您目的的广告素材（例如图形，视频和数字广告）为您的品牌创建新故事。","services":"利用通过创造性工作获得的知识，我们正在不同领域发展多种业务。"},"en":{"title":"Solutions","mission":{"1":"Spiral","2":"","3":"","4":"Our missions are to continuously update production of creative, like the spiral structure which keeps going up infinitely without passing the same position twice, and to create businesses which can advance brands and society further."},"introduction":"Our strength is our business which operates by utilizing the knowledge acquired through creative works. We provide the path to solving problems which only Helicx can do and our output is dignified and shows strong technique.","creative":"We spin new stories for brands through ideal creative for the purpose such as graphics, images, digital and so on.","services":"We develop multiple businesses in various fields by utilizing knowledge acquired through creative works."}}'), delete t.options._Ctor
            }
        },
        363: function (t, e, o) {
            "use strict";
            ...
            var c = {
                    data: function () {
                        return {
                            ...
                            assetsDir: "https://helicx.cc/assets", /* 客户素材 */
                            title: this.$t.bind(this)("title"),
                            description: "ja" === this.$i18n.locale ? "Helicx Co.，Ltd.是一家使用创意解决方案来解决问题的总体计划公司。 我们计划和管理各种不受框架约束的事物，例如广告制作，品牌和数字产品开发以及艺术家管理。" : "Helicx Inc. is a planning company uses creativity to solve problems. We integrate strategy, creativity and experience to build brands.",
                            className: "solutions",
